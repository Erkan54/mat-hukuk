  ...
  return (
    <section className="relative section-padding bg-cream overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Desktop Layout - Card Deal Animation */}
        <motion.div
          initial="hidden"
          whileInView="show"
          viewport={{ once: true, margin: '-50px' }}
          className="hidden lg:grid grid-cols-3 gap-8 items-stretch min-h-[520px]"
        >
          {team.map((lawyer, index) => {
            // Card deal angles and staggered offsets
            const cardVariants = {
              hidden: {
                opacity: 0,
                x: index === 0 ? 150 : index === 2 ? -150 : 0,
                y: 80,
            ...
            return (
              <motion.div
                ...
                className="relative bg-white rounded-3xl p-6 shadow-xl shadow-navy/5 border border-border/40 flex flex-col justify-between group overflow-hidden"
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-text-secondary font-medium mb-4">{lawyer.barNumber}</p>
                ...
                <div className="pt-4 border-t border-border/50 flex items-center justify-between">
                  <div className="text-xs text-text-secondary">
                    <span className="font-semibold text-navy">{lawyer.experience}</span>
                  </div>
                  <Link
                    to="/ekibimiz"
