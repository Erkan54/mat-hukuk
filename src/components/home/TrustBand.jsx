      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-center gap-8 sm:gap-16 md:gap-24">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-gold/10 flex items-center justify-center text-gold shrink-0">
            ...
            <span className="font-serif text-lg sm:text-2xl font-bold text-navy tracking-wide">
              Danışmanlık
            </span>
          </div>

          {/* Divider */}
          <div className="w-px h-7 sm:h-9 bg-gold/35 shrink-0" />
