    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled || !isHome
            ? 'bg-white/95 backdrop-blur-md border-b border-navy/10 shadow-lg shadow-navy/10 py-2.5'
            : 'bg-white/80 backdrop-blur-md border-b border-navy/10 shadow-md shadow-navy/5 py-3.5'
        }`}
      >
